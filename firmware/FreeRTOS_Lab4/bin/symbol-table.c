__attribute__((section(".symbol_table"))) const char APP_SYM_TABLE[] =
	...
	"0001bccc T vsniprintf\n"
	"0001bccc T vsnprintf\n"
	...
	"00011604 T Uart3::Uart3()\n"
	"000175d8 T LabSPI::selectChip()\n"
	"000175e8 T LabSPI::deselectChip()\n"
	"00017530 T LabSPI::init(unsigned char, unsigned char, unsigned char, unsigned char)\n"
	"0001759c T LabSPI::transfer(unsigned char)\n"
	"0001752c T LabSPI::LabSPI()\n"
	"0001752c T LabSPI::LabSPI()\n"
	"000175f8 T LabSPI::~LabSPI()\n"
	"000175f8 T LabSPI::~LabSPI()\n"
	...
	"00017e08 T std::type_info::__is_pointer_p() const\n"
	"00017e08 T std::type_info::__is_function_p() const\n"
	"00017e0c T std::type_info::operator==(std::type_info const&) const\n"
	"00017e06 T std::type_info::~type_info()\n"
	"00017e06 T std::type_info::~type_info()\n"
	"00017e40 T std::get_terminate()\n"
	"00017e50 T std::terminate()\n"
;
