__attribute__((section(".symbol_table"))) const char APP_SYM_TABLE[] =
	...
	"00011604 T Uart3::Uart3()\n"
	"000175ac T LabSPI::selectChip()\n"
	"000175bc T LabSPI::deselectChip()\n"
	"00017530 T LabSPI::init(unsigned char, unsigned char, unsigned char, unsigned char)\n"
	"00017598 T LabSPI::transfer(unsigned char)\n"
	"0001752c T LabSPI::LabSPI()\n"
	"0001752c T LabSPI::LabSPI()\n"
	"000175cc T LabSPI::~LabSPI()\n"
	"000175cc T LabSPI::~LabSPI()\n"
	...
	"00017d24 T std::type_info::__is_pointer_p() const\n"
	"00017d24 T std::type_info::__is_function_p() const\n"
	"00017d28 T std::type_info::operator==(std::type_info const&) const\n"
	"00017d22 T std::type_info::~type_info()\n"
	"00017d22 T std::type_info::~type_info()\n"
	"00017d5c T std::get_terminate()\n"
	"00017d6c T std::terminate()\n"
;
