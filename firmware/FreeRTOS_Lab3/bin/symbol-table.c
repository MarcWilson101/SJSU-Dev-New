__attribute__((section(".symbol_table"))) const char APP_SYM_TABLE[] =
	...
	"0001bcd4 T vsniprintf\n"
	"0001bcd4 T vsnprintf\n"
	...
	"00017584 T ADCDriver::adcSelectPin(unsigned char)\n"
	"00017530 T ADCDriver::adcInitBurstMode(unsigned char)\n"
	"000175d0 T ADCDriver::readADCRawByChannel(unsigned char)\n"
	"0001752c T ADCDriver::ADCDriver()\n"
	"0001752c T ADCDriver::ADCDriver()\n"
	"0001729c T IR_Sensor::storeIrCode(unsigned long)\n"
	"000172b8 T IR_Sensor::decodeIrCode()\n"
	"0001731c T IR_Sensor::init()\n"
	"000175f8 T PWMDriver::pwmSelectPin(unsigned char)\n"
	"000176c4 T PWMDriver::setDutyCycle(unsigned char, float)\n"
	"00017648 T PWMDriver::pwmInitSingleEdgeMode(unsigned long)\n"
	"00017e0c T std::type_info::__is_pointer_p() const\n"
	"00017e0c T std::type_info::__is_function_p() const\n"
	"00017e10 T std::type_info::operator==(std::type_info const&) const\n"
	"00017e0a T std::type_info::~type_info()\n"
	"00017e0a T std::type_info::~type_info()\n"
	"00017e44 T std::get_terminate()\n"
	"00017e54 T std::terminate()\n"
;
